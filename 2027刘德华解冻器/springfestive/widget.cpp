...
{
    QDateTime target(QDate(2027, 2, 5), QTime(0, 0, 0));
    ...
    if (secsLeft > 0)
    {
        countdownText = QString("距离2027年过年还有：%1天 %2小时 %3分 %4秒")
                            .arg(days)
                            .arg(hours)
                            .arg(minutes)
                            .arg(seconds);
    ...
    QDateTime start(QDate(2026, 2, 17), QTime(0, 0, 0));
    ...
    else
    {
        ...
        passedText = QString("距离2026年过年已经过去：%1天 %2小时 %3分 %4秒")
                         .arg(p_days)
                         .arg(p_hours)
                         .arg(p_minutes)
                         .arg(p_seconds);
